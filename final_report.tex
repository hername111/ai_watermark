...
The most influential LLM watermarking algorithm is the KGW green-list method of Kirchenbauer et al. \cite{kirchenbauer2023}.
...
MarkLLM provides a unified implementation and evaluation framework for text watermarking methods \cite{markllm2024}, while the ACL watermarking tutorial summarizes design choices such as green-list construction, secret keys, detection thresholds, quality metrics, and robustness evaluation \cite{tutorial2024}.
...
\begin{enumerate}
  ...
  \item We evaluate the two text watermarks across detection accuracy, z-score behavior, ROC/AUC, false positives, generation quality, latency, parameter sensitivity, and robustness to deletion and synonym-substitution attacks.
...
\end{enumerate}
Together, these experiments connect the standard LLM watermarking literature with a structured-data setting that is relevant for future multimodal and data-generating foundation models.
